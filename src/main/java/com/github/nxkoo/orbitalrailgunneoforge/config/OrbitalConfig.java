package com.github.nxkoo.orbitalrailgunneoforge.config;
...
public final class OrbitalConfig {
    ...
    public static final ModConfigSpec.IntValue COOLDOWN;
    public static final ModConfigSpec.IntValue STRIKE_DAMAGE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> BLACKLISTED_BLOCKS;
    public static final ModConfigSpec.BooleanValue SUCK_ENTITIES;
    public static final ModConfigSpec.DoubleValue DESTRUCTION_DIAMETER;
    public static final ModConfigSpec.IntValue BLOCKS_PER_TICK;
    public static final ModConfigSpec.IntValue MIN_DESTROY_Y;
    public static final ModConfigSpec.BooleanValue DROP_BLOCKS;
    public static final ModConfigSpec.BooleanValue DEBUG;
    public static final ModConfigSpec.BooleanValue RESPECT_CLAIMS;
    public static final ModConfigSpec.BooleanValue RESPECT_OPAC_CLAIMS;
    public static final ModConfigSpec.BooleanValue ALLOW_ENTITY_DAMAGE_IN_CLAIMS;
    public static final ModConfigSpec.BooleanValue ALLOW_BLOCK_BREAK_IN_CLAIMS;
    public static final ModConfigSpec.BooleanValue ALLOW_EXPLOSIONS_IN_CLAIMS;
    public static final ModConfigSpec.BooleanValue OPS_BYPASS_CLAIMS;
    ...
    public static final class Client {
        public final ModConfigSpec.ConfigValue<String> beamColorHex;
        public final ModConfigSpec.DoubleValue beamAlpha;

        public final ModConfigSpec.ConfigValue<String> markerInnerHex;
        public final ModConfigSpec.DoubleValue markerInnerAlpha;

        public final ModConfigSpec.ConfigValue<String> markerOuterHex;
        public final ModConfigSpec.DoubleValue markerOuterAlpha;
